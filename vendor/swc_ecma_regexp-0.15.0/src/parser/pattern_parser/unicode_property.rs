// Mangler modification: Unicode 17 Script aliases from the Unicode Character Database.
use phf::{phf_set, Set};
...
static SC_PROPERTY_VALUES: Set<&'static str> = phf_set! {
    // Unicode 17.0 PropertyValueAliases.txt; exact ECMAScript alias matching.
    "Berf", "Beria_Erfe",
    "Sidt", "Sidetic",
    "Tayo", "Tai_Yo",
    "Tols", "Tolong_Siki",
