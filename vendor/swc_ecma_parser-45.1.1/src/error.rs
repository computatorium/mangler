    ...
    pub fn msg(&self) -> Cow<'static, str> {
        match self {
            ...
            SyntaxError::EvalAndArgumentsInStrict => "'eval' and 'arguments' cannot be used as a \
                ...
                .into(),
            SyntaxError::DuplicateExport => "Duplicate exported name".into(),
            SyntaxError::DuplicateParameter => {
            ...
            SyntaxError::InvalidNewTarget => "'new.target' is only allowed in the body of a \
                ...
                .into(),
            SyntaxError::InvalidImportAttributes => "Invalid or duplicate import attribute".into(),
            SyntaxError::InvalidModuleExportName => {
                "Module export name contains an unpaired surrogate".into()
            }
            ...
            SyntaxError::InvalidRegExp(message) => message.clone().into(),
